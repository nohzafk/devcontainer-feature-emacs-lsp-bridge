...
# emacs lsp-bridge typescript_eslint language server (typescript_eslint)

emacs lsp-bridge typescript_eslint language server environment installed by Nix Pacakge Manager
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/nohzafk/devcontainer-feature-emacs-lsp-bridge/blob/main/src/typescript_eslint/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
