...
# emacs lsp-bridge ballerina-lang-server language server (ballerina-lang-server)

emacs lsp-bridge ballerina-lang-server language server environment installed by Nix Pacakge Manager

## Example Usage

```json
"features": {
    "ghcr.io/nohzafk/devcontainer-feature-emacs-lsp-bridge/ballerina-lang-server:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/nohzafk/devcontainer-feature-emacs-lsp-bridge/blob/main/src/ballerina-lang-server/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
