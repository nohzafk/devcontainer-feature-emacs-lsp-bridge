...
# emacs lsp-bridge rust-analyzer language server (rust-analyzer)

emacs lsp-bridge rust-analyzer language server environment installed by Nix Pacakge Manager

## Example Usage

```json
"features": {
    "ghcr.io/nohzafk/devcontainer-feature-emacs-lsp-bridge/rust-analyzer:0": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/nohzafk/devcontainer-feature-emacs-lsp-bridge/blob/main/src/rust-analyzer/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
