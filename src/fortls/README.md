...
# emacs lsp-bridge fortls language server (fortls)

emacs lsp-bridge fortls language server environment installed by Nix Pacakge Manager

## Example Usage

```json
"features": {
    "ghcr.io/nohzafk/devcontainer-feature-emacs-lsp-bridge/fortls:0": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/nohzafk/devcontainer-feature-emacs-lsp-bridge/blob/main/src/fortls/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
