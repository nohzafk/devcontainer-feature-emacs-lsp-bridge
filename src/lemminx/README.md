...
# emacs lsp-bridge lemminx language server (lemminx)

emacs lsp-bridge lemminx language server environment installed by Nix Pacakge Manager

## Example Usage

```json
"features": {
    "ghcr.io/nohzafk/devcontainer-feature-emacs-lsp-bridge/lemminx:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/nohzafk/devcontainer-feature-emacs-lsp-bridge/blob/main/src/lemminx/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
