...
# emacs lsp-bridge vscode-eslint-language-server language server (vscode-eslint-language-server)

emacs lsp-bridge vscode-eslint-language-server language server environment installed by Nix Pacakge Manager

## Example Usage

```json
"features": {
    "ghcr.io/nohzafk/devcontainer-feature-emacs-lsp-bridge/vscode-eslint-language-server:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/nohzafk/devcontainer-feature-emacs-lsp-bridge/blob/main/src/vscode-eslint-language-server/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
