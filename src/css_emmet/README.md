...
# emacs lsp-bridge css_emmet language server (css_emmet)

emacs lsp-bridge css_emmet language server environment installed by Nix Pacakge Manager

## Example Usage

```json
"features": {
    "ghcr.io/nohzafk/devcontainer-feature-emacs-lsp-bridge/css_emmet:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/nohzafk/devcontainer-feature-emacs-lsp-bridge/blob/main/src/css_emmet/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
