...
# emacs lsp-bridge angular_template_typescript language server (angular_template_typescript)

emacs lsp-bridge angular_template_typescript language server environment installed by Nix Pacakge Manager

## Example Usage

```json
"features": {
    "ghcr.io/nohzafk/devcontainer-feature-emacs-lsp-bridge/angular_template_typescript:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/nohzafk/devcontainer-feature-emacs-lsp-bridge/blob/main/src/angular_template_typescript/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
