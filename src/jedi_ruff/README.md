...
# emacs lsp-bridge jedi_ruff language server (jedi_ruff)

emacs lsp-bridge jedi_ruff language server environment installed by Nix Pacakge Manager

## Example Usage

```json
"features": {
    "ghcr.io/nohzafk/devcontainer-feature-emacs-lsp-bridge/jedi_ruff:0": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/nohzafk/devcontainer-feature-emacs-lsp-bridge/blob/main/src/jedi_ruff/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
