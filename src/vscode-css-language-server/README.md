...
# emacs lsp-bridge vscode-css-language-server language server (vscode-css-language-server)

emacs lsp-bridge vscode-css-language-server language server environment installed by Nix Pacakge Manager
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/nohzafk/devcontainer-feature-emacs-lsp-bridge/blob/main/src/vscode-css-language-server/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
