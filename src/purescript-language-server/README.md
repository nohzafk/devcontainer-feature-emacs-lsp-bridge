...
# emacs lsp-bridge purescript-language-server language server (purescript-language-server)

emacs lsp-bridge purescript-language-server language server environment installed by Nix Pacakge Manager

## Example Usage

```json
"features": {
    "ghcr.io/nohzafk/devcontainer-feature-emacs-lsp-bridge/purescript-language-server:0": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/nohzafk/devcontainer-feature-emacs-lsp-bridge/blob/main/src/purescript-language-server/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
