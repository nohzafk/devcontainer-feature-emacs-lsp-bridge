...
# emacs lsp-bridge gleam language server (gleam)

emacs lsp-bridge gleam language server environment installed by Nix Pacakge Manager
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/nohzafk/devcontainer-feature-emacs-lsp-bridge/blob/main/src/gleam/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
