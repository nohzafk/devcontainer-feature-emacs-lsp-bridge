...
# emacs lsp-bridge pyright_ruff language server (pyright_ruff)

emacs lsp-bridge pyright_ruff language server environment installed by Nix Pacakge Manager
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/nohzafk/devcontainer-feature-emacs-lsp-bridge/blob/main/src/pyright_ruff/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
