...
# emacs lsp-bridge angular-ls language server (angular-ls)

emacs lsp-bridge angular-ls language server environment installed by Nix Pacakge Manager

## Example Usage

```json
"features": {
    "ghcr.io/nohzafk/devcontainer-feature-emacs-lsp-bridge/angular-ls:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/nohzafk/devcontainer-feature-emacs-lsp-bridge/blob/main/src/angular-ls/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
