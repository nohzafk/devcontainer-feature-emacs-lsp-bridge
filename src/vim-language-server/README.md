...
# emacs lsp-bridge vim-language-server language server (vim-language-server)

emacs lsp-bridge vim-language-server language server environment installed by Nix Pacakge Manager

## Example Usage

```json
"features": {
    "ghcr.io/nohzafk/devcontainer-feature-emacs-lsp-bridge/vim-language-server:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/nohzafk/devcontainer-feature-emacs-lsp-bridge/blob/main/src/vim-language-server/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
