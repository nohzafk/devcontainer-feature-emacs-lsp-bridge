...
# emacs lsp-bridge jedi language server (jedi)

emacs lsp-bridge jedi language server environment installed by Nix Pacakge Manager

## Example Usage

```json
"features": {
    "ghcr.io/nohzafk/devcontainer-feature-emacs-lsp-bridge/jedi:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/nohzafk/devcontainer-feature-emacs-lsp-bridge/blob/main/src/jedi/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
