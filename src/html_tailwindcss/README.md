...
# emacs lsp-bridge html_tailwindcss language server (html_tailwindcss)

emacs lsp-bridge html_tailwindcss language server environment installed by Nix Pacakge Manager

## Example Usage

```json
"features": {
    "ghcr.io/nohzafk/devcontainer-feature-emacs-lsp-bridge/html_tailwindcss:0": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/nohzafk/devcontainer-feature-emacs-lsp-bridge/blob/main/src/html_tailwindcss/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
