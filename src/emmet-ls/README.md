...
# emacs lsp-bridge emmet-ls language server (emmet-ls)

emacs lsp-bridge emmet-ls language server environment installed by Nix Pacakge Manager

## Example Usage

```json
"features": {
    "ghcr.io/nohzafk/devcontainer-feature-emacs-lsp-bridge/emmet-ls:0": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/nohzafk/devcontainer-feature-emacs-lsp-bridge/blob/main/src/emmet-ls/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
